...
SELINA_MANDRAKE_ENG_IMAGES__SOURCE_PREFIX := $(SELINA_MANDRAKE__VCS_DIR)/graphics/fron
...
TERM_LIBERATION_IMAGES__BASE := emma-watson-wandless.svg.webp gotta-be-a-badass-to-play-one.svg.webp
