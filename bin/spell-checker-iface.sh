...
find dest/t2/ -name '*.html' -or -name '*.xhtml' |
    ...
    grep -vP '^dest/t2/rindolf/intro_to_rindolf\.html$' |
    ...
    grep -vP '\.raw\.html$' |
    grep -vP '^\Qdest/t2/js/jquery-ui\E' |
    grep -vP '^\Qdest/t2/open-source/anti/TIOBE/Berke-Durak--anti-TIOBE--Mirror\E' |
    grep -vP '^\Qdest/t2/philosophy/philosophy/putting-all-cards-on-the-table-2013/indiv-sections/\E' |
    grep -vP '^\Qdest/t2/philosophy/philosophy/putting-all-cards-on-the-table-2013/DocBook5/\E' |
    grep -vP '^\Qdest/t2/philosophy/philosophy/SummerNSA-2014-09-call-for-action/DocBook5/\E' |
