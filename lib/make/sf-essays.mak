...
SW_QUALITY_REFLECTIONS_ESSAY__MARKDOWN := lib/notes/quality-software--followup-2018.md
SW_QUALITY_REFLECTIONS_ESSAY__DOCBOOK5 := $(DOCBOOK5_XML_DIR)/reflections-on-software-quality-trends.xml

all_deps: $(SW_QUALITY_REFLECTIONS_ESSAY__MARKDOWN)

$(SW_QUALITY_REFLECTIONS_ESSAY__MARKDOWN): $(SW_QUALITY_REFLECTIONS_ESSAY__DOCBOOK5)
	( set -e -x ; printf "%s\\n\\n" "**WARNING!!** This file is now generated by lib/make/sf-essays.mak . DO NOT MODIFY directly!" && ( pandoc -f docbook -t gfm --columns=1000 < $< | $(PERL) -lp $(LATEMP_ROOT_SOURCE_DIR)/bin/reindent-pandoc-gh-flavored-markdown-output-to-4-spaces.pl ) ) > $@
