...
$(FORTS_EPUB_DEST): $(FORTUNES_XHTMLS) $(FORTUNES_XHTMLS_TOCS) $(FORTS_EPUB_ALL_COVERS)
	export PYTHONPATH="$${PYTHONPATH}:$(SCREENPLAY_COMMON_INC_DIR)" SCREENPLAY_COMMON_INC_DIR="$(SCREENPLAY_COMMON_INC_DIR)" DFN="$(PWD)/$(FORTS_EPUB_DEST)"  ; cd $(FORTUNES_XHTMLS_DIR) && python3 $(PWD)/bin/make_epub.py --output "$$DFN" "book.json"
