...
selina_mandrake: $(SELINA_MANDRAKE_ENG_SCREENPLAY_XML_SOURCE) $(SELINA_MANDRAKE_ENG_TXT_FROM_VCS) $(SELINA_MANDRAKE_ENG_IMAGES__POST_DEST) $(SO_WHO_THE_HELL_IS_QOHELETH_ENG_IMAGES__POST_DEST) $(QUEEN_PADME_TALES_IMAGES__POST_DEST) $(TERMINATOR_LIBERATION_ENG_IMAGES__POST_DEST)
...
PROC_INCLUDES_COMMON2 = APPLY_TEXTS=1 xargs $(PROCESS_ALL_INCLUDES__NON_INPLACE) --mode=minify --minifier-conf bin/mod1--html-min-cli-config-file.conf --texts-dir=lib/ads --source-dir=$(1) --dest-dir=$(2) --
