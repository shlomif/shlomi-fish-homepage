...
SCREENPLAY_XML__PDFS__DEFAULT_STYLESHEET = $(POST_DEST)/screenplay-xml-pdfs.css

$(SCREENPLAY_XML__PDFS__POST_DESTS): %.pdf: %.raw.html $(SCREENPLAY_XML__PDFS__DEFAULT_STYLESHEET)
	weasyprint "$<" "$@" --stylesheet $(SCREENPLAY_XML__PDFS__DEFAULT_STYLESHEET)
