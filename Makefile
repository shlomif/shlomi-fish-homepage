...
T2_TARGETS = $(T2_DIRS_DEST) $(T2_COMMON_IMAGES_DEST) $(T2_IMAGES_DEST) $(T2_COMMON_DIRS_DEST) $(T2_DOCS_DEST) 

VIPE_TARGETS = $(VIPE_DIRS_DEST) $(VIPE_COMMON_IMAGES_DEST) $(VIPE_IMAGES_DEST) $(VIPE_COMMON_DIRS_DEST) $(VIPE_DOCS_DEST) 
