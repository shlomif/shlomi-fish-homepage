...
SELINA_MANDRAKE_ENG_IMAGES__SOURCE_PREFIX := $(SELINA_MANDRAKE__VCS_DIR)/graphics
SELINA_MANDRAKE_ENG_IMAGES__POST_DEST_PREFIX := $(POST_DEST_HUMOUR_SELINA)/images
SELINA_MANDRAKE_ENG_IMAGES__SOURCE := $(addprefix $(SELINA_MANDRAKE_ENG_IMAGES__SOURCE_PREFIX)/,$(SELINA_MANDRAKE_ENG_IMAGES__BASE))
SELINA_MANDRAKE_ENG_IMAGES__POST_DEST := $(addprefix $(SELINA_MANDRAKE_ENG_IMAGES__POST_DEST_PREFIX)/,$(SELINA_MANDRAKE_ENG_IMAGES__BASE))

SO_WHO_THE_HELL_IS_QOHELETH_ENG_IMAGES__BASE := Friends-S02E04--Nothing-Sexier.svg.jpg If-You-Wanna-Be-Sad.svg.jpg Standup-Philosopher.svg.webp sigourney-weaver--resized.jpg summer-glau--two-guns--400w.jpg

SO_WHO_THE_HELL_IS_QOHELETH_ENG_IMAGES__SOURCE_PREFIX := $(SO_WHO_THE_HELL_IS_QOHELETH__VCS_DIR)/graphics
SO_WHO_THE_HELL_IS_QOHELETH_ENG_IMAGES__POST_DEST_PREFIX := $(POST_DEST_HUMOUR)/So-Who-The-Hell-Is-Qoheleth/images

SO_WHO_THE_HELL_IS_QOHELETH_ENG_IMAGES__SOURCE := $(addprefix $(SO_WHO_THE_HELL_IS_QOHELETH_ENG_IMAGES__SOURCE_PREFIX)/,$(SO_WHO_THE_HELL_IS_QOHELETH_ENG_IMAGES__BASE))
SO_WHO_THE_HELL_IS_QOHELETH_ENG_IMAGES__POST_DEST := $(addprefix $(SO_WHO_THE_HELL_IS_QOHELETH_ENG_IMAGES__POST_DEST_PREFIX)/,$(SO_WHO_THE_HELL_IS_QOHELETH_ENG_IMAGES__BASE))


QUEEN_PADME_TALES_ENG_IMAGES__BASE := Christina_Grimmie_in_November_2014--resized.webp bad-blood189.webp evilphish-svg--facing-right.min.svg.png tacos6306095903_a5c92746ba_o--tacos-reduced-by-jeffreyw--small-400px.webp
...
QUEEN_PADME_TALES_IMAGES__SOURCE := $(addprefix $(QUEEN_PADME_TALES_IMAGES__SOURCE_PREFIX)/,$(QUEEN_PADME_TALES_ENG_IMAGES__BASE))
QUEEN_PADME_TALES_IMAGES__POST_DEST := $(addprefix $(QUEEN_PADME_TALES_IMAGES__POST_DEST_PREFIX)/,$(QUEEN_PADME_TALES_ENG_IMAGES__BASE))


TERM_LIBERATION_ENG_IMAGES__BASE := emma-watson-wandless.svg.webp gotta-be-a-badass-to-play-one.svg.webp
...
TERM_LIBERATION_IMAGES__SOURCE := $(addprefix $(TERM_LIBERATION_IMAGES__SOURCE_PREFIX)/,$(TERM_LIBERATION_ENG_IMAGES__BASE))
TERM_LIBERATION_IMAGES__POST_DEST := $(addprefix $(TERM_LIBERATION_IMAGES__POST_DEST_PREFIX)/,$(TERM_LIBERATION_ENG_IMAGES__BASE))
...
selina_mandrake: $(SELINA_MANDRAKE_ENG_SCREENPLAY_XML_SOURCE) $(SELINA_MANDRAKE_ENG_TXT_FROM_VCS) $(SELINA_MANDRAKE_ENG_FRON_IMAGE__POST_DEST) $(SO_WHO_THE_HELL_IS_QOHELETH_ENG_IMAGES__POST_DEST) $(QUEEN_PADME_TALES_IMAGES__POST_DEST) $(TERM_LIBERATION_IMAGES__POST_DEST)
