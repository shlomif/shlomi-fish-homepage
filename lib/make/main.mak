...
POST_DEST_MANIFEST_HTML_PATH := $(POST_DEST)/MANIFEST.html

post_latemp_deps: $(POST_DEST_MANIFEST_HTML_PATH)
...
$(POST_DEST_MANIFEST_HTML_PATH): $(LATEMP_ROOT_SOURCE_DIR)/bin/gen-manifest.pl $(ALL_HTACCESSES) $(SPORK_LECTURES_DEST_STARTS) $(FORTS_EPUB_DEST) $(SRC_CLEAN_STAMP)
	$(PERL) $<
