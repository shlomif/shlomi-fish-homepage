...
sub get_html
{
    ...
    else
    {
        return
            ...
            $self->get_nav_links() .
            qq{<button id="toggle_sect_menu" onclick="javascript:toggle_sect_menu()" class="toggle_sect_menu off" title="Show or Hide the Section Navigation Menu">Hide</button>\n} .
