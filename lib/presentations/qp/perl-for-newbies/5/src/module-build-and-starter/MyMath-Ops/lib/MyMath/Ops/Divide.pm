...
MyMath::Ops::Divide - The great new MyMath::Ops::Divide!
...
Perhaps a little code snippet.
    ...
    use MyMath::Ops::Divide;

    my $foo = MyMath::Ops::Divide->new();
    ...
