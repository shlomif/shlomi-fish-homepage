...
qr#(?:humour/by-others/(?:English-is-a-Crazy-Language|darien|funroll-loops|hitchhiker|how-many-newsgroup-readers|oded-c|s-stands-for-simple|technion-bit-1|top-12-things-likely|was-the-death-star-attack|grad-student-jokes-from-jnoakes|the-fountainhead-starring-skull-force|if-people-bought-cars))#,
    qr#^post-dest/t2/humour/fortunes/all-in-one#,
    qr#^post-dest/t2/humour/fortunes/sharp#,
    qr#^post-dest/t2/humour/fortunes/source-files-list.html#,
...
qr#post-dest/t2/philosophy/computers/high-quality-software/what-makes-software-high-quality#,
qr#post-dest/t2/philosophy/computers/open-source/linus-torvalds-bus-factor/index#,
    qr#\.raw\.html$#,
    qr#^\Qpost-dest/t2/js/jquery-ui\E#,
    qr#^\Qpost-dest/t2/Iglu/shlomif/gamla\E#,
qr#^\Qpost-dest/t2/open-source/anti/TIOBE/Berke-Durak--anti-TIOBE--Mirror\E#,
    qr#^\Qpost-dest/t2/open-source/resources/tech-tips/\E#,
