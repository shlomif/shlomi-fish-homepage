...
MyMath::Ops::Subtract - The great new MyMath::Ops::Subtract!
...
Perhaps a little code snippet.
    ...
    use MyMath::Ops::Subtract;

    my $foo = MyMath::Ops::Subtract->new();
    ...
