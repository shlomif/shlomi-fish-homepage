...
MyMath::Ops::Multiply - The great new MyMath::Ops::Multiply!
...
Perhaps a little code snippet.
    ...
    use MyMath::Ops::Multiply;

    my $foo = MyMath::Ops::Multiply->new();
    ...
