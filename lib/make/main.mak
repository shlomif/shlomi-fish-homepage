...
SCREENPLAY_SOURCES_ON_DEST = $(DEST_SPLAY_ST_WeTheLiving) $(DEST_INTERVIEWS)/ae-interview.txt $(DEST_INTERVIEWS)/sussman-interview.txt $(DEST_SPLAY_HHGG_STTNG) $(DEST_HUMOUR)/Buffy/A-Few-Good-Slayers/buffy--a-few-good-slayers.txt $(DEST_SPLAY_QOHELETH) $(DEST_SPLAY_Terminator_Liberation)
