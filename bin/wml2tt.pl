...
my $re =
qr#(?:about_sect|github_cpan_dist_links|intro|perl_for_newbies_entry|news_sect|note|modern_perl_entry|beginning_perl_entry|cpan_dist|pdoc|pdoc_f|licence_sect|links_sect|see_also|h[234]_section)#;
