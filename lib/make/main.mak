...
ALL_HTACCESSES = $(T2_FORTUNES_DIR_HTACCESS) $(DEST_HUMOUR)/.htaccess dest/t2/open-source/.htaccess $(DEST_HUMOUR)/humanity/songs/.htaccess $(T2_DEST)/lecture/PostgreSQL-Lecture/.htaccess
