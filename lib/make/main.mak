...
QUEEN_PADME_TALES_ENG_IMAGES__SOURCE_PREFIX := $(QUEEN_PADME_TALES__VCS_DIR)/graphics
QUEEN_PADME_TALES_ENG_IMAGES__POST_DEST_PREFIX := $(POST_DEST_HUMOUR)/Queen-Padme-Tales/images

QUEEN_PADME_TALES_ENG_IMAGES__POST_DEST := $(addprefix $(QUEEN_PADME_TALES_ENG_IMAGES__POST_DEST_PREFIX)/,$(QUEEN_PADME_TALES_ENG_IMAGES__BASE))

TERMINATOR_LIBERATION_ENG_IMAGES__SOURCE_PREFIX := $(TERMINATOR_LIBERATION__VCS_DIR)/graphics
TERMINATOR_LIBERATION_ENG_IMAGES__POST_DEST_PREFIX := $(POST_DEST_HUMOUR)/Terminator/Liberation/images

TERMINATOR_LIBERATION_ENG_IMAGES__POST_DEST := $(addprefix $(TERMINATOR_LIBERATION_ENG_IMAGES__POST_DEST_PREFIX)/,$(TERMINATOR_LIBERATION_ENG_IMAGES__BASE))

SUMMERSCHOOL_AT_THE_NSA_ENG_IMAGES__SOURCE_PREFIX := $(SUMMERSCHOOL_AT_THE_NSA__VCS_DIR)/graphics
SUMMERSCHOOL_AT_THE_NSA_ENG_IMAGES__POST_DEST_PREFIX := $(POST_DEST_HUMOUR)/Summerschool-at-the-NSA/images

SUMMERSCHOOL_AT_THE_NSA_ENG_IMAGES__POST_DEST := $(addprefix $(SUMMERSCHOOL_AT_THE_NSA_ENG_IMAGES__POST_DEST_PREFIX)/,$(SUMMERSCHOOL_AT_THE_NSA_ENG_IMAGES__BASE))
...
selina_mandrake: $(SELINA_MANDRAKE_ENG_SCREENPLAY_XML_SOURCE) $(SELINA_MANDRAKE_ENG_TXT_FROM_VCS) $(SELINA_MANDRAKE_ENG_IMAGES__POST_DEST) $(SO_WHO_THE_HELL_IS_QOHELETH_ENG_IMAGES__POST_DEST) $(QUEEN_PADME_TALES_IMAGES__POST_DEST) $(TERMINATOR_LIBERATION_ENG_IMAGES__POST_DEST) $(SUMMERSCHOOL_AT_THE_NSA_ENG_IMAGES__POST_DEST)
