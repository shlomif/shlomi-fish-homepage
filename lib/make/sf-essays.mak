...
$(SW_QUALITY_REFLECTIONS_ESSAY__MARKDOWN): $(SW_QUALITY_REFLECTIONS_ESSAY__DOCBOOK5)
	( printf "%s\\n\\n" "**WARNING!!** This file is now generated by lib/make/sf-essays.mak . DO NOT MODIFY directly!" && ( pandoc -f docbook -t gfm --columns=1000 < $< | $(PERL) -lpE 's&^((?:  )+)(\-)& $$x = length($$1)/2 ; ( ( qq[ ] x ($$x * 4) ) . $$2 )&ems' ) ) > $@
